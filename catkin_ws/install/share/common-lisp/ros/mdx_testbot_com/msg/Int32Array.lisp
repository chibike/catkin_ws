...
(cl:defmethod cl:initialize-instance :after ((m <Int32Array>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Int32Array)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mdx_testbot_com-msg:<Int32Array> is deprecated: use mdx_testbot_com-msg:Int32Array instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <Int32Array>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mdx_testbot_com-msg:data-val is deprecated.  Use mdx_testbot_com-msg:data instead.")
  (data m))
