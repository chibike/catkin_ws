...
(cl:defmethod cl:initialize-instance :after ((m <Int32Array>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Int32Array)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name see_n_tell-msg:<Int32Array> is deprecated: use see_n_tell-msg:Int32Array instead.")))
